...
export default function Home() {
  return (
    <div className="h-[100vh] flex items-center justify-center bg-[#393A59]">
      <div className="flex flex-col max-w-[800px] h-[500px] overflow-hidden rounded-[6px] border-[1px] border-gray-500 m-[20px] cursor-text">
        <div className="flex items-center text-center flex-row h-[24px] w-full bg-[#424040] cursor-default py-[8px]">
          ...
          <div className="flex-1 text-center"><h1 className="bg-[#9c9c9c] text-[13px]">github.com/shivansh-bhatnagar18</h1></div>
        </div>
